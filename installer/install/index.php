...
<html>
  <head>
    ...
    <style type="text/css">
      ...
      .Preloader {position: absolute; width: 150px; height: 150px; z-index: 15; left: 50%; top: 50%; transform: translate(-50%,-50%);  }
      .Preloader img {position: absolute; top: 50%; left: 50%; transform: translate(-50%,-50%);    border-radius: 10px;height: 150px;width: 200px;max-width: 200px; }
      .locaderoverlay {position: absolute; top: 0; left: 0; height: 100%; width: 100%; background-color: rgba(0,0,0,0.5); z-index: 10;  }
      #main_loader{display:none;}
    </style>
  </head>
  <body>
  <div id="main_loader" >
        ...
        <div class="Preloader">
            <img src="../timer.gif" alt="Preloader">
        </div>
    </div>
    <?php
$errors = false;
    ...
    <div class="container">
      <div class="section">
        <div class="column is-6 is-offset-3">
          <center>
            <h1 class="title" style="padding-top: 20px">EventRight Installation</h1><br>
          </center>
          <div class="box">
            <?php
switch ($step) {
                ...
                <form action="#" id="admin-detail-form" method="POST">
                  <div class="field">
                    <label class="label">Admin Email</label>
                      <div class="control">
                        <input class="input" type="email" id="email" placeholder="Enter your admin email" required name="email"  >
                  ...
                  <div class="field">
                    <label class="label">Admin Password</label>
                      <div class="control">
                        <input class="input" type="text" id="password" placeholder="Enter your admin password" required name="password">
